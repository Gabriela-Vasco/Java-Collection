...
public class ExemploMap {
    public static void main(String[] args) {
        ...
        System.out.println("Exiba o terceiro modelo adicionado: "); // não é possível exibir a ordem no HashMap
        ...
        Iterator<Double> iterator = carrosPopulares.values().iterator(); //consegue chamar o iterator porque o retorno do carrosPopulares é uma collection
        Double soma = 0d;
